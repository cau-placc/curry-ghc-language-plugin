...
import qualified SharingAcrossND
...
main = do
  ...
  res <- case args of
         [x] -> case x of
           ...
           "YesSharingND"   -> return $ show $ eval DFS SharingAcrossND.testSharing
           "NoSharingND"    -> return $ show $ eval DFS SharingAcrossND.testNoSharing
...
deriving instance Show Nat.Nat
